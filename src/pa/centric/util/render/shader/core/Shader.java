package pa.centric.util.render.shader.core;
...
public class Shader {
    ...
    public Shader(String path) {
        init(FileUtil.readInputStream(mc.getResourceManager().getResource(new ResourceLocation("centric/shader/impl/" + path + ".frag")).getInputStream()));
    }
    ...
    private void init(String source) {
        ...
        ARBShaderObjects.glAttachObjectARB(program, createShader(FileUtil.readInputStream(mc.getResourceManager().getResource(new ResourceLocation("centric/shader/vertex.vert")).getInputStream()), GL_VERTEX_SHADER));
