...
import static pa.centric.util.render.RenderUtils.reAlphaInt;
...
public class ColorUtil implements IMinecraft {
    ...
    public static int setAlphaColor(final int color, final float alpha) {
    ...
    public static int getColorStyle(float index) {
        return conduction.STYLE_MANAGER.getCurrentStyle().getColor((int) index);
    }
