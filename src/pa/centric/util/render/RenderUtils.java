...
import other.jhlabs.image.GaussianFilter;
...
import static pa.centric.util.render.RenderUtils.IntColor.*;
...
public class RenderUtils implements IMinecraft {
    ...
    public static Vector3d getEntityPos(Entity entity, float f) {
        double d = MathUtil.interpolate(entity.getPosX(), entity.lastTickPosX, f) - mc.getRenderManager().renderPosX();
        double d2 = MathUtil.interpolate(entity.getPosY(), entity.lastTickPosY, f) - mc.getRenderManager().renderPosY();
        double d3 = MathUtil.interpolate(entity.getPosZ(), entity.lastTickPosZ, f) - mc.getRenderManager().renderPosZ();
        return new Vector3d(d, d2, d3);
    }
    public static org.joml.Vector3d interpolate(Entity entity, float partialTicks) {
    ...
    public static class Render2D {
        ...
        public static void drawShadow(float x, float y, float width, float height, int radius, int color) {
            Optimization optimization = conduction.FUNCTION_MANAGER.optimization;
