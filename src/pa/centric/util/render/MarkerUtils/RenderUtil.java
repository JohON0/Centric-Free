...
public class RenderUtil implements IMinecraft {
    ...
    public static Vector2d project2D(double x, double y, double z) {
        ...
        if (RenderUtil.mc.getRenderManager().info == null) {
            return new Vector2d();
        }
        Vector3d cameraPosition = RenderUtil.mc.getRenderManager().info.getProjectedView();
        ...
        if (RenderUtil.mc.gameSettings.viewBobbing && (renderViewEntity = mc.getRenderViewEntity()) instanceof PlayerEntity) {
        ...
        double fieldOfView = (float)RenderUtil.mc.gameRenderer.getFOVModifier(RenderUtil.mc.getRenderManager().info, mc.getRenderPartialTicks(), true);
