...
import pa.centric.util.render.ScaleMath;
import pa.centric.util.render.Vec2i;
...
public class Dragging {
    ...
    public final void onClick(double mouseX, double mouseY, int button) {
        ...
        mouseX = fixed.getX();
        mouseY = fixed.getY();
        if (button == 0 && RenderUtils.isInRegion(mouseX, mouseY, xPos, yPos, width, height)) {
