package pa.centric.client.ui.proxy;
...
public class ProxyUI extends Screen {
    ...
    ProxyConnection pc = conduction.PROXY_CONN;
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        FontUtils.sfbold[14].drawCenteredString(matrixStack, "Активный прокси: " + cProxy, center[0], center[1] - 30, -1);

        FontUtils.sfbold[14].drawCenteredString(matrixStack, "Пример: socks4://123.123.123.123:1234", center[0], center[1] + 60, -1);
