...
public class Particles extends Function {
    private static ModeSetting particle = new ModeSetting("Фигура", "Сердце", "Сердце", "Звезда", "Доллар", "Иконка чита", "Кругляшки");
