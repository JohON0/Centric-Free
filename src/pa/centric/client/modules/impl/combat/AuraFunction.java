...
public class AuraFunction extends Function {
    ...
    private final ModeSetting rotationMode = new ModeSetting("Мод ротации", "Обычная", "Обычная", "Снапы", "HolyWorld"
    );
    ...
    public final ModeSetting targetesp = new ModeSetting("Сортировать",
            "Nursultan",
            "Nursultan", "Окружность"
