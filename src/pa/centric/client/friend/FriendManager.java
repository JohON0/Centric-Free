package pa.centric.client.friend;
...
public class FriendManager {
    ...
    public static final File file = new File(Minecraft.getInstance().gameDir, "\\Centric\\Client_1_16_5\\friendslist.cc");
    ...
    public void init() throws IOException {
        if (!file.exists()) {
            ...
            System.out.println(Centric.prefix + "Прочитал файл с друзьями");
            readFriends();
        }
    }
