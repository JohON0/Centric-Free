...
public abstract class LivingEntity extends Entity {
    ...
    protected void jump() {
        ...
        if (conduction.FUNCTION_MANAGER.auraFunction.state && conduction.FUNCTION_MANAGER.auraFunction.settings.get(1)) {
            if (this.isSprinting()) {
                float f1 = conduction.FUNCTION_MANAGER.auraFunction.rotate.x * ((float) Math.PI / 180F);
...
/*        if (conduction.FUNCTION_MANAGER.auraFunction.state && conduction.FUNCTION_MANAGER.auraFunction.correction.get()) {
            if (this.isSprinting()) {
                float f1 = conduction.FUNCTION_MANAGER.auraFunction.rotate.x * ((float) Math.PI / 180F);
                this.setMotion(this.getMotion().add((double) (-MathHelper.sin(f1) * 0.2F), 0.0D, (double) (MathHelper.cos(f1) * 0.2F)));
            }
        ...
        if (conduction.FUNCTION_MANAGER.autoExplosionFunction.check()) {
            if (this.isSprinting()) {
                float f1 = conduction.FUNCTION_MANAGER.autoExplosionFunction.server.x * ((float) Math.PI / 180F);
                this.setMotion(this.getMotion().add((double) (-MathHelper.sin(f1) * 0.2F), 0.0D, (double) (MathHelper.cos(f1) * 0.2F)));
            }
...
//        if (conduction.FUNCTION_MANAGER.scaffold.state && conduction.FUNCTION_MANAGER.scaffold.rotation != null) {
//            if (this.isSprinting()) {
//                float f1 =  conduction.FUNCTION_MANAGER.scaffold.rotation.x * ((float) Math.PI / 180F);
//                this.setMotion(this.getMotion().add((double) (-MathHelper.sin(f1) * 0.2F), 0.0D, (double) (MathHelper.cos(f1) * 0.2F)));
//            }
//
//            this.isAirBorne = true;
...
//        }
        ...
        if (this.isServerWorld() || this.canPassengerSteer()) {
            ...
            if (this.isInWater() && this.func_241208_cS_() && !this.func_230285_a_(fluidstate.getFluid())) {
                ...
                if (conduction.FUNCTION_MANAGER.auraFunction.state && conduction.FUNCTION_MANAGER.auraFunction.settings.get(1) && this instanceof ClientPlayerEntity) {
                    vector3d1 = this.getVectorForRotation(conduction.FUNCTION_MANAGER.auraFunction.rotate.y, conduction.FUNCTION_MANAGER.auraFunction.rotate.x);
                }
                float f = this.rotationPitch * ((float) Math.PI / 180F);
                if (conduction.FUNCTION_MANAGER.auraFunction.state && conduction.FUNCTION_MANAGER.auraFunction.settings.get(1) && this instanceof ClientPlayerEntity) {
                    f = conduction.FUNCTION_MANAGER.auraFunction.rotate.y * ((float) Math.PI / 180F);
                }
    ...
    public boolean canBePushed() {
        if (conduction.FUNCTION_MANAGER.noPushFunction.state && conduction.FUNCTION_MANAGER.noPushFunction.modes.get(0) &&
