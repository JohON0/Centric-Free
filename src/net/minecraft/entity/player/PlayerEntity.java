...
public abstract class PlayerEntity extends LivingEntity {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            SprintFunction sprintFunction = conduction.FUNCTION_MANAGER.sprintFunction;

                            if (sprintFunction.state && sprintFunction.keepSprint.get() && conduction.FUNCTION_MANAGER.auraFunction != null && this instanceof ClientPlayerEntity) {
    ...
    public boolean isPushedByWater() {
        if (conduction.FUNCTION_MANAGER.noPushFunction.state && conduction.FUNCTION_MANAGER.noPushFunction.modes.get(2))
            return false;
