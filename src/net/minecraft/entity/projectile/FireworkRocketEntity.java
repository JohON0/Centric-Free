        ...
        if (this.isAttachedToEntity()) {
            ...
            if (this.boostedEntity != null) {
                if (this.boostedEntity.isElytraFlying()) {
                    if (conduction.FUNCTION_MANAGER.auraFunction.state && conduction.FUNCTION_MANAGER.auraFunction.settings.get(1) && boostedEntity instanceof ClientPlayerEntity) {
                        Vector3d vector3d = this.getVectorForRotation(conduction.FUNCTION_MANAGER.auraFunction.rotate.y, conduction.FUNCTION_MANAGER.auraFunction.rotate.x);
