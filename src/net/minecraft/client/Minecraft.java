...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
    ...
    public Minecraft(GameConfiguration gameConfig) {
        ...
        Centric initilization = new Centric();
        initilization.init();
    ...
    public String getVersion() {
        return ClientUtils.legitMode ? "Optifine 1.16.5" : this.launchedVersion;
    }
    ...
    private void processKeyBinds() {
        ...
        if (this.currentScreen != null && !(conduction.FUNCTION_MANAGER.autoGApple.state && conduction.FUNCTION_MANAGER.autoGApple.canEat()))
            return;
