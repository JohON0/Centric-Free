...
public class FogRenderer {
    ...
    public static void updateFogColor(ActiveRenderInfo activeRenderInfoIn, float partialTicks, ClientWorld worldIn, int renderDistanceChunks, float bossColorModifier) {
        ...
        CustomWorld customWorld = conduction.FUNCTION_MANAGER.customWorld;
        ...
        if (fluidstate.isTagged(FluidTags.WATER)) {
            ...
            Vector3d vector3d4 = CubicSampler.func_240807_a_(vector3d3, (p_lambda$updateFogColor$0_3_, p_lambda$updateFogColor$0_4_, p_lambda$updateFogColor$0_5_) ->
                    worldIn.func_239132_a_().func_230494_a_(Vector3d.unpack(biomemanager.getBiomeAtPosition(p_lambda$updateFogColor$0_3_, p_lambda$updateFogColor$0_4_, p_lambda$updateFogColor$0_5_).getFogColor()), f12));
            ...
            if (customWorld.state && customWorld.modes.get(1)) {
                final float[] colors = RenderUtils.IntColor.rgb(RenderUtils.reAlphaInt(ColorUtil.getColorStyle(0), 10));
                red = colors[0];
                green = colors[1];
                blue = colors[2];
            } else {
