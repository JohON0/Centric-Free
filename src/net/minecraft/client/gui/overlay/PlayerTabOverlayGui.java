...
public class PlayerTabOverlayGui extends AbstractGui {
    ...
    private static final long ANIMATION_DURATION = 500; // ƒÎËÚÂÎ¸ÌÓÒÚ¸ ‡ÌËÏ‡ˆËË ‚ ÏËÎÎËÒÂÍÛÌ‰‡ı
    ...
    private final Pattern prefixMatches = Pattern.compile(".*(mod|der|adm|help|wne|ÏÓ‰|ıÂÎÔ|ÔÓÏÓ|‡‰Ï|‚Î‡‰Â|ÓÚË|Ú‡Ù|taf|curat|ÍÛ‡ÚÓ|dev|‡Á|supp|Ò‡ÔÔ|yt|˛ÚÛ·).*");
    ...
    public void func_238523_a_(MatrixStack p_238523_1_, int p_238523_2_, Scoreboard p_238523_3_, @Nullable ScoreObjective p_238523_4_) {
        ...
        if (list1 != null) {
            if (conduction.FUNCTION_MANAGER.noRenderFunction.state) {
                if (conduction.FUNCTION_MANAGER.noRenderFunction.element.get(3)) {
                    //Õ≈“” ¿¬’¿’’¬¿’¬¿’¬¿’¬¿’¬¿’¬¿’’¬¿’¬¿
                } else {
    ...
    protected void func_238522_a_(MatrixStack p_238522_1_, int p_238522_2_, int p_238522_3_, int p_238522_4_, NetworkPlayerInfo p_238522_5_) {
        ...
        FontUtils.sfbold[10].drawStringWithOutline(p_238522_1_, ping, (p_238522_3_ + p_238522_2_ - 2 - FontUtils.sfbold[10].getWidth(ping)), (float) p_238522_4_ + 5.5f, j);
