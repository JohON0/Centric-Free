...
import pa.centric.events.impl.player.*;
...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
    ...
    private void onUpdateWalkingPlayer() {
        ...
        if (!(this.isCurrentViewEntity() && conduction.FUNCTION_MANAGER.get("Freecam").state)) {
            ...
            if (conduction.FUNCTION_MANAGER.timerFunction.mode.is("Matrix")) {
                conduction.FUNCTION_MANAGER.timerFunction.updateTimer(eventPre.getYaw(), eventPre.getPitch(), eventPre.getX(), this.getPosY(), eventPre.getZ());
            }
    ...
    public void sendChatMessage(String message) {
        ...
        conduction.COMMAND_MANAGER.runCommands(message);
