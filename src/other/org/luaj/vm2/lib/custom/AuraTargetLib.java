...
import other.org.luaj.vm2.compiler.jse.CoerceJavaToLua;
import other.org.luaj.vm2.customs.EntityHook;
...
public class AuraTargetLib extends TwoArgFunction {
    ...
    public LuaValue call(LuaValue modname, LuaValue env) {
        ...
        library.set("getTarget", new OneArgFunction() {
            ...
            public LuaValue call(LuaValue arg) {
                return CoerceJavaToLua.coerce(new EntityHook(conduction.FUNCTION_MANAGER.auraFunction.getTarget()));
            }
        });
    ...
    static class isActiveTarget extends ZeroArgFunction {
        ...
        public LuaValue call() {
            LivingEntity target = conduction.FUNCTION_MANAGER.auraFunction.getTarget();
